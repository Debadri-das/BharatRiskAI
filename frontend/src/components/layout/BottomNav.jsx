import { Activity, AlertTriangle, BarChart3, RadioTower, Settings } from 'lucide-react';
import { useUiStore } from '../../store/uiStore';
const items = [['Dashboard', Activity], ['Risk Analysis', BarChart3], ['Reports', AlertTriangle], ['Emergency Center', RadioTower], ['Settings', Settings]];
